...
```
.claude/skills/excalidraw-visuals/brand-assets/excalidraw-style-reference.png
```

Always include: `--input ".claude/skills/excalidraw-visuals/brand-assets/excalidraw-style-reference.png"`
