---
name: trigger-ref
description: Trigger.dev SDK v4 code reference: task, schedules.task with cron, schemaTask with Zod, triggering and triggerAndWait, batch triggers, idempotency keys, waits, debounce, retries, orchestrator plus processor pattern, and the v2 syntax to avoid. Use when writing or reviewing Trigger.dev task code, or when someone types /trigger-ref.
---
