    ...
    <PageTemplate title={title} subtitle={subtitle} variant="dark" breadcrumbs={breadcrumbs}>
      <div className="space-y-16">
        <div
          ...
          aria-label="Digerati Experts operating context"
          data-testid="service-proof-context"
        >
          <ProofChip metric="24/7" label="Human-led monitoring" icon={Shield} />
          ...
          <section data-testid="section-process">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              {narrative.process.map((step, index) => (
                ...
                >
                  <div className="mb-2 font-mono text-[11px] font-bold uppercase tracking-widest text-[#F04C97]">
