...
export default function Accounting() {
  const metrics = [
    { label: "Compliance Pass Rate", value: "99.8%", icon: CheckCircle, color: "text-green-400" },
    { label: "Avg. Audit Findings", value: "0.2", icon: TrendingUp, color: "text-blue-400" },
    { label: "Data Protection", value: "256-bit", icon: Lock, color: "text-purple-400" },
    { label: "Uptime Guarantee", value: "99.95%", icon: Activity, color: "text-amber-400" }
  ];
            ...
            return (
              <div key={idx} className="group relative">
                ...
                <Card className="relative h-full bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 hover:shadow-xl transition-all duration-300">
                  <CardHeader>
                    <Icon className="h-10 w-10 text-green-400 mb-2 group-hover:scale-110 transition-transform" />
