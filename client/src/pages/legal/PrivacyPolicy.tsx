        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-300 mb-4">We collect personal information that you voluntarily provide when you:</p>
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">2.2 Client Data</h3>
              <p className="text-gray-300 mb-4">
                When providing managed services, we may have access to and process certain data on behalf of our clients, including:
              </p>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
                <li><strong className="text-white">Protected Health Information (PHI)</strong>: For healthcare clients, governed by HIPAA Business Associate Agreements</li>
                <li><strong className="text-white">Cardholder Data</strong>: For clients subject to PCI DSS requirements</li>
                <li><strong className="text-white">System logs and security event data</strong>: Collected through monitoring and security tools</li>
                <li><strong className="text-white">Network traffic metadata</strong>: For security monitoring purposes</li>
                <li><strong className="text-white">Employee account information</strong>: For user management and access control</li>
              </ul>

              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">2.3 Automatically Collected Information</h3>
            ...
            <div className="mb-12">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">3.1 Service Delivery</h3>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">3.2 Business Operations</h3>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">3.3 Marketing Communications</h3>
            ...
            <div className="mb-12">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">4.1 Technical Safeguards</h3>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
                <li><strong className="text-white">Encryption</strong>: AES-256 encryption for data at rest; TLS 1.3 for data in transit</li>
                <li><strong className="text-white">Access Controls</strong>: Role-based access control (RBAC) and multi-factor authentication (MFA)</li>
                <li><strong className="text-white">Network Security</strong>: Next-generation firewalls, intrusion detection/prevention systems</li>
                <li><strong className="text-white">Endpoint Protection</strong>: Advanced endpoint detection and response (EDR) on all systems</li>
                <li><strong className="text-white">Security Monitoring</strong>: 24/7 Security Operations Center (SOC) monitoring</li>
                <li><strong className="text-white">Vulnerability Management</strong>: Regular security scans and patch management</li>
              </ul>

              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">4.2 Administrative Safeguards</h3>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">4.3 Certifications & Compliance</h3>
              <ul className="list-disc pl-6 text-gray-300 space-y-2">
            ...
            <div className="mb-12 bg-amber-500/10 backdrop-blur-sm border border-amber-500/30 border-l-4 border-l-amber-500 p-6 rounded">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">5.1 Personal Information Covered</h3>
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">5.2 Notification Timeline</h3>
              <p className="text-gray-300 mb-4">
                We will provide notice of any breach affecting personal information <strong className="text-white">within 45 days</strong> of discovery, 
                unless a law enforcement agency determines that notification would impede a criminal investigation.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">5.3 Notification Method</h3>
              <p className="text-gray-300">
            ...
            {/* Information Sharing */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">6. Information Sharing and Disclosure</h2>
              
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">6.1 We Do NOT Sell Your Data</h3>
              <p className="text-gray-300 mb-4">
                <strong className="text-white">We do not sell, rent, or trade your personal information to third parties.</strong> Your data 
                is used solely for providing our services and protecting your security.
              </p>

              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">6.2 Service Providers</h3>
              <p className="text-gray-300 mb-4">We may share information with trusted service providers who assist us:</p>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">6.3 Legal Obligations</h3>
              <p className="text-gray-300 mb-4">We may disclose information when required by law:</p>
              <ul className="list-disc pl-6 text-gray-300 space-y-2">
            ...
            {/* Data Retention */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">7. Data Retention and Deletion</h2>
              <p className="text-gray-300 mb-4">
                We retain your information only as long as necessary to provide services and comply with legal obligations:
              </p>
              <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
                <li><strong className="text-white">Client Data</strong>: Retained per your Master Service Agreement, typically through contract term + 7 years</li>
                <li><strong className="text-white">Security Logs</strong>: Retained for 1 year minimum (compliance requirements may extend this)</li>
                <li><strong className="text-white">Backups</strong>: Retained per backup retention policy (typically 30-90 days)</li>
                <li><strong className="text-white">Marketing Data</strong>: Until you opt out or request deletion</li>
                <li><strong className="text-white">Billing Records</strong>: 7 years per tax and accounting requirements</li>
              </ul>

              <h3 className="text-2xl font-semibold text-white mb-3 mt-6">7.1 Secure Deletion</h3>
              <p className="text-gray-300">
            ...
            {/* Your Rights */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">9. Your Privacy Rights</h2>
            ...
            {/* Third-Party Links */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">11. Third-Party Links</h2>
              <p className="text-gray-300">
            ...
            {/* Children's Privacy */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">12. Children's Privacy</h2>
              <p className="text-gray-300">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">13. International Data Transfers</h2>
              <p className="text-gray-300">
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">14. Changes to This Privacy Policy</h2>
              <p className="text-gray-300">
