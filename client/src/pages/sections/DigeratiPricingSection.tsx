          ...
          <div className="flex flex-col justify-center gap-6 p-6 md:p-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl">
              <h3 className="text-xl font-semibold text-white md:text-2xl">
                Compare capabilities and operating depth
              </h3>
              <p className="mt-2 text-sm leading-relaxed text-white/60 md:text-base">
                Not sure which package fits? We assess users, devices, locations, infrastructure,
                security, compliance, recovery, and whether you need fully managed or co-managed
                coverage. User count is a signal, never the sole criterion.
              </p>
