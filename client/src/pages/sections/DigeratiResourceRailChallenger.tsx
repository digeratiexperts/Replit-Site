        ...
        <div className="grid overflow-hidden rounded-2xl border border-white/10 bg-white/[0.035] md:grid-cols-2">
          ...
          >
            ...
            <span className="min-w-0 flex-1">
              <span className="block text-xs font-semibold uppercase tracking-[0.16em] text-white/45">Live intelligence</span>
              <span className="mt-1 block text-base font-semibold text-white">Security Updates</span>
              <span className="mt-1 block text-sm leading-5 text-white/55">Active exploitation, CISA advisories, Microsoft security updates, and scored SMB relevance.</span>
            </span>
            <ArrowRight className="h-4 w-4 shrink-0 text-white/35 transition-transform group-hover:translate-x-1 group-hover:text-white" aria-hidden="true" />
          </a>
          ...
          >
            <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-white/12 bg-white/[0.05] text-white/80">
              <BookOpen className="h-5 w-5" aria-hidden="true" />
            </span>
            <span className="min-w-0 flex-1">
              <span className="block text-xs font-semibold uppercase tracking-[0.16em] text-white/45">Guidance & analysis</span>
              <span className="mt-1 block text-base font-semibold text-white">Digerati Journal</span>
              <span className="mt-1 block text-sm leading-5 text-white/55">Practical security, compliance, cloud, identity, and managed IT guidance for business leaders.</span>
            </span>
            <ArrowRight className="h-4 w-4 shrink-0 text-white/35 transition-transform group-hover:translate-x-1 group-hover:text-white" aria-hidden="true" />
          </a>
        </div>
