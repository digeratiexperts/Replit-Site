      ...
      <div className="flex flex-col lg:flex-row items-start gap-6 lg:gap-8 justify-between relative self-stretch w-full flex-[0_0_auto]">
        <Card className="inline-flex items-center gap-2.5 px-0 py-8 relative flex-1 bg-[#f0f3ff] rounded-[30px] overflow-hidden border border-solid border-[#333333] shadow-[-11px_16px_32px_-9px_#0000001a] backdrop-blur-[23px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(23px)_brightness(100%)]">
          <CardContent className="relative w-full max-w-[554px] mx-auto p-6 flex flex-col gap-6">
            <div className="flex flex-col items-center gap-4 w-full">
              <h2 className="font-normal text-[#020029] text-3xl text-center tracking-[0] leading-normal">
                What&apos;s Downtime Really Costing You?
              </h2>

              <p className="font-normal text-[#020029bf] text-base text-center tracking-[0] leading-[26.4px]">
            ...
            <div className="flex flex-col w-full items-start gap-4">
              <div className="flex flex-col gap-2 w-full">
                <Label className="font-normal text-[#020029] text-base tracking-[0] leading-[27.2px]">
                  {leftCardInputs[0].label}
                </Label>
                <Input
                  defaultValue={leftCardInputs[0].value}
                  data-testid="input-industry"
                  className="h-[50px] px-4 font-normal text-[#020029] text-[13px] tracking-[0] border-[#0000001f] rounded-[25px] border border-solid shadow-[inset_0px_1px_1px_#00000013] bg-transparent"
                />
              </div>
            ...
            <div className="flex flex-col w-full items-start gap-2">
              {costEstimates.map((estimate, index) => (
                ...
                >
                  <div className="font-normal text-[#02002980] text-base tracking-[0] leading-[27.2px]">
                    {estimate.label}
                  </div>
                  <div className="font-normal text-[#020029] text-base leading-[27.2px] tracking-[0]">
                    {estimate.value}
                  </div>
                </div>
              ))}
            ...
            <p className="w-full font-normal text-[#02002980] text-base tracking-[0] leading-[27.2px] text-center">
        ...
        <Card className="relative flex-1 bg-[#100a25] rounded-[30px] overflow-hidden border border-solid border-[#f0f3ff] shadow-[-11px_16px_32px_-9px_#0000001a] backdrop-blur-[23px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(23px)_brightness(100%)]">
          <CardContent className="relative w-full max-w-[531px] mx-auto p-6 flex flex-col gap-6">
            <div className="flex flex-col items-center gap-4 w-full">
              <h2 className="font-normal text-white text-3xl text-center tracking-[0] leading-normal">
                Estimate Your Service Cost Now
              </h2>

              <p className="font-normal text-[#ffffffbf] text-base text-center tracking-[0] leading-[26.4px]">
            ...
            <div className="flex flex-col w-full items-start gap-4">
              <div className="flex flex-col gap-2 w-full">
                <Label className="font-normal text-white text-base tracking-[0] leading-[27.2px]">
                  {rightCardInputs[0].label}
                </Label>
                <Input
                  defaultValue={rightCardInputs[0].value}
                  data-testid="input-num-employees"
                  className="h-[50px] px-4 font-normal text-white text-[13px] tracking-[0] border-[#f0f3ff80] rounded-[25px] border border-solid shadow-[inset_0px_1px_1px_#00000013] bg-transparent"
                />
              </div>
            ...
            <div className="w-full flex flex-col bg-[#00000040] rounded-2xl p-6 gap-2">
              <div className="font-black text-white text-4xl tracking-[0]">
                $0.00
              </div>
              <div className="font-normal text-white text-base tracking-[0]">
                Monthly Total • Per-Employee: $0.00
              </div>
              <div className="font-normal text-white text-sm tracking-[0]">
                Quarterly: $0.00
              </div>
            </div>
            ...
            <button 
              ...
              className="text-white font-normal text-base tracking-[-0.32px] leading-6 bg-transparent border-0 cursor-pointer hover:underline">
