    ...
    <section className="flex items-center justify-between gap-16 w-full">
      <div className="flex flex-col items-start gap-[18px] flex-1">
        ...
        >
          ...
          <span className="font-bold text-[#020029] text-sm tracking-[0] leading-[23.8px] whitespace-nowrap">
            24/7 Security Response Team
          </span>
        </Badge>

        <div className="flex flex-col items-start gap-4 w-full">
          <h2 className="font-normal text-[#020029] text-[52px] tracking-[0] leading-[73px]">
      ...
      <Button className="h-12 px-4 py-2 bg-[#5034ff] hover:bg-[#5034ff]/90 rounded-[100px] border border-solid gap-2">
        <span className="font-normal text-white text-base tracking-[-0.32px] leading-6 whitespace-nowrap">
          Report Incident
        </span>
        <img
          className="w-8 h-8"
