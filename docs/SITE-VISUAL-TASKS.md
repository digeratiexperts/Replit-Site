...
| **VIS-002** | `EvidenceFrame` + Classifications | Antigravity | `main` | VIS-001 | `client/src/components/evidence/EvidenceFrame.tsx` | **IN PROGRESS** | Pending | — |
| **VIS-003** | `HUDFrame` + `StatusToken` + `ProofChip` | Antigravity | `main` | VIS-001 | `client/src/components/evidence/HUDFrame.tsx`, `StatusToken.tsx`, `ProofChip.tsx` | **IN PROGRESS** | Pending | — |
...
| **VIS-008** | `IncidentFlow` Example Scenario Module | Antigravity | `main` | VIS-002, VIS-003 | `client/src/components/evidence/IncidentFlow.tsx` | **IN PROGRESS** | Pending | — |
