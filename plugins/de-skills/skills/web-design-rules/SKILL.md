---
name: web-design-rules
description: Reference rules for building a standalone HTML page or mockup with high design craft, matching a reference image pixel-for-pixel, and verifying it with localhost screenshots. Use when someone asks to build a landing page, mockup, single-file site, or to match a design reference, outside the React app in client/.
---

> **Digerati Experts repository note (local addition, not upstream text).**
> This file was supplied by Joe as a standalone project `CLAUDE.md` ("Frontend
> Website Rules"). It is vendored here as a reference skill because this
> repository's `CLAUDE.md` is the governance pointer and must stay as it is.
